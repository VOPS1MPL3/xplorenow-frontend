...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnIrOtp.setOnClickListener(v ->
                Navigation.findNavController(requireView())
                        .navigate(R.id.action_login_to_otpSolicitar));
        ...
        tvOlvideContrasena.setOnClickListener(v ->
                Navigation.findNavController(requireView())
                        .navigate(R.id.action_login_to_olvide));

        btnBiometria.setOnClickListener(v -> autenticarConBiometria());
    }

    private void autenticarConBiometria() {
        if (!tokenManager.isTokenValid()) {
            tokenManager.clearToken();
            btnBiometria.setVisibility(View.GONE);
            Toast.makeText(requireContext(),
